...
velocity.o: velocity.cpp vectorXYZ.o velocity.h date.h constants.h
...
grid_construction.out: grid_construction.o parameters.o velocity.o VTK.o ioutil.o vectorXYZ.o constants.o
	$(CC)  parameters.o grid_construction.o velocity.o vectorXYZ.o VTK.o ioutil.o constants.o -o grid_construction.out $(LIBS) -fopenmp

lagrangian_engine.out: lagrangian_engine.o parameters.o velocity.o ioutil.o vectorXYZ.o constants.o
	$(CC)  parameters.o lagrangian_engine.o vectorXYZ.o velocity.o ioutil.o constants.o -o lagrangian_engine.out $(LIBS) -fopenmp

matrix_construction.out: matrix_construction.o parameters.o ioutil.o constants.o
